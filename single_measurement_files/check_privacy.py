...
def check_privacy_risks(original_dataset, train_syn_with_target, test_syn_with_target, known_attribute_distributions, input_secret, num_of_attacks, what_kind_of_list): 
    ...
    #For Inference Risk
    aux_list_2 = None
    if what_kind_of_list == 0:
        aux_list_2 = known_attribute_distributions[0]
    else:
        aux_list_2 = known_attribute_distributions
